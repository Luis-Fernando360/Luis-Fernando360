...
<p align="center">
  <img src="https://raw.githubusercontent.com/Luis-Fernando360/Luis-Fernando360/main/banner.png" alt="QA Banner" />
</p>
...
- QA Automation (básico / basic)

### 🔹 API & Backend
- API Testing (Postman)  
- Validación de respuestas, status codes y schemas  
- SQL básico / Basic SQL  

### 🔹 Metodologías
- Agile / Scrum  
- Casos de prueba, reportes de bugs y documentación  
...
- 🔹 **Proyecto de control de calidad – Aplicación urbana**  
  _Quality assurance project for an urban application_

- 🔹 **Proyecto de control de calidad – Rutas urbanas**  
  _QA project focused on urban route systems_
